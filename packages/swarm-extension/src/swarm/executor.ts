/**
 * Swarm agent execution via gajae-code's subagent infrastructure.
 *
...
import { runSubprocess } from "@gajae-code/coding-agent";
...
/**
 * Execute a single swarm agent as an gajae-code subagent.
 *
 * The agent receives:
