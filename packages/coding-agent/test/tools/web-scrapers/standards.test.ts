...
import { handleCheatSh } from "@gajae-code/coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@gajae-code/coding-agent/web/scrapers/rfc";
import { handleTldr } from "@gajae-code/coding-agent/web/scrapers/tldr";
